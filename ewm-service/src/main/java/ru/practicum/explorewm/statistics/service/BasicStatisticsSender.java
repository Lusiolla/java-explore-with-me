...
public class BasicStatisticsSender {
    ...
    private <T> ResponseEntity<Object> makeAndSendRequest(
        ...
        ResponseEntity<Object> exploreWithMeStatisticsResponse;

        try {
            exploreWithMeStatisticsResponse = rest.exchange(path, method, requestEntity, Object.class);
        } catch (HttpStatusCodeException e) {
            return ResponseEntity.status(e.getStatusCode()).body(e.getResponseBodyAsByteArray());
        }
        return prepareGatewayResponse(exploreWithMeStatisticsResponse);
    }
